# BGG Integration System

Owns BGG collection refresh, game data provision, authentication and publishing.

## Implementation

`pull/`, `collection-fetch/`, `reconcile/`, `provider/`, `ratings/`, `plays/`, `push/`, `audit/`, `auth/`.
